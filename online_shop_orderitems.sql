...
INSERT INTO `orderitems` VALUES (1,1,11,5),(2,2,12,8),(3,3,13,45),(4,4,14,35),(5,5,15,54),(6,1,12,2);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `update_stock_after_order` AFTER INSERT ON `orderitems` FOR EACH ROW BEGIN
    UPDATE products
